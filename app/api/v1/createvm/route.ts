...
const ExtendedNameParser = ComputeInsSchema.extend({
    name : ComputeInsSchema.shape.name.refine(async(name)=>{
               ...
               data : {
                instances : {
                    create : {
                        ...
                        natIp : response_data.networkInterfacesNameAccessConfigsList[0].natIP,
                        networkInterfacesAccessName : response_data.networkInterfacesNameAccessConfigsList[0].name,
